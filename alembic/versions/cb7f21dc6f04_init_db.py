...
Revision ID: cb7f21dc6f04
Revises: 
Create Date: 2025-08-26 22:53:59.692044
...
def upgrade() -> None:
    ...
    sa.Column('entro_treinamento_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['entro_treinamento_id'], ['centros_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
